...
public class VCardEntry {
    ...
    public enum EntryLabel {
        ...
        ANNIVERSARY,
        ANDROID_CUSTOM,
        CALL_DATETIME //<-Jerry@220120:获取通话记录时间戳
    }
    ...
    public static class NameData implements EntryElement {
        ...
        public String toString() {
            return String.format("family: %s, given: %s, middle: %s, prefix: %s, suffix: %s, displayName: %s, mSortString: %s",
                    mFamily, mGiven, mMiddle, mPrefix, mSuffix,displayName,mSortString);
        }
    ...
    //Jerry@220120:获取通话记录时间戳-->
    public static class CallDatetimeData implements EntryElement {
        private String mCallDatetime;
        private Collection<String> typeCollection;

        public CallDatetimeData(){

        }
        public CallDatetimeData(String datetime,Collection<String> typeCollection) {
        ...
        public void setCallDatetime(String mCallDatetime) {
            this.mCallDatetime= mCallDatetime;
        }

        public Collection<String> getTypeCollection() {
            return typeCollection;
        }

        public void setTypeCollection(Collection<String> typeCollection) {
            this.typeCollection = typeCollection;
        }
    }
    //<--Jerry@220120:获取通话记录时间戳
    ...
    private CallDatetimeData mCallDatetimeData = new CallDatetimeData();
    ...
    public void addProperty(final VCardProperty property) {
        ...
        } else if (propertyName.equals(VCardConstants.PROPERTY_X_IRMC_CALL_DATETIME)) {//Jerry@220120:获取通话记录时间戳
            Collection<String> typeCollection = paramMap.get(VCardConstants.PARAM_TYPE);
            mCallDatetimeData = new CallDatetimeData(propValue,typeCollection);
    ...
    public final CallDatetimeData getCallDate() {
        return mCallDatetimeData != null ? mCallDatetimeData : null;
    }
