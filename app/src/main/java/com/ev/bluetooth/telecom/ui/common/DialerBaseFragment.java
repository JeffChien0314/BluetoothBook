...
package com.ev.bluetooth.telecom.ui.common;
...
public abstract class DialerBaseFragment extends Fragment {
    ...
    /*protected Drawable getFullScreenBackgroundColor() {
       // return getActivity().getDrawable(R.drawable.layout_main_bg);
    ...
    protected final void setActionBarBackground(@Nullable Drawable drawable) {
        ...
        /* if (activity instanceof PhoneBookActivity) {
            ((PhoneBookActivity) activity).setActionBarBackground(drawable);
        } */
    }
}
