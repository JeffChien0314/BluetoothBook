...
public class BluetoothMasClient {
    ...
    private class SocketConnectThread extends Thread {
        ...
        public void run() {
            try {
                /*Class<BluetoothDevice> BluetoothDevice = BluetoothDevice.class;//得到BluetoothDevice的Class对象

                Method method = BluetoothDevice.getDeclaredMethod("createRfcommSocket", Integer.class);
                //打开权限
                method.setAccessible(true);
                socket = (BluetoothSocket) method.invoke(mMas.getRfcommCannelNumber());
                socket.connect();*/
