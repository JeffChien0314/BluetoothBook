...
class BluetoothMnsService {
    ...
    private static class SocketAcceptThread extends Thread {
        ...
        public void run() {
            ...
            try {
                Class<BluetoothAdapter> adapter = BluetoothAdapter.class;
                Method method = adapter.getDeclaredMethod("listenUsingEncryptedRfcommWithServiceRecord", String.class, UUID.class);
                //打开权限
                method.setAccessible(true);
                mServerSocket = (BluetoothServerSocket) method.invoke("MAP Message Notification Service", MAP_MNS.getUuid());
